...
type WorkspaceViewState = {
  ...
  /** Whether the bottom archived-session section is expanded. */
...
export function createWorkspaceViewStore(): EngineStoreHandle<WorkspaceViewState, WorkspaceViewActions> {
  return defineStore({
    ...
    // v6: the archived-section expansion flag joined the persisted viewing
    // state; rehydration is wholesale, so an old payload lacks the field.
