...
export const zh = {
  ...
  'status.jobsRunning.one': '{n} 个后台任务运行中',
  'status.jobsRunning.other': '{n} 个后台任务运行中',
  'status.idle': '空闲',
...
export const en = {
  ...
  'status.jobsRunning.one': '{n} background job running',
  'status.jobsRunning.other': '{n} background jobs running',
  'status.idle': 'Idle',
